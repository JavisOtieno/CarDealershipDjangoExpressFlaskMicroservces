...
try {
    // Convert the route parameter to a number and search using the 'id' field from the schema
    ...
    res.status(500).send(error.stack); // Sends the full error stack for debugging
